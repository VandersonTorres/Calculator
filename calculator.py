...
# CRIAÇÃO DE FRAMES
window_frame = Frame(window, width=433, height=50, bg=color1)      # Window dividing and choosing background color
window_frame.grid(columnspan=5)
main_frame = Frame(window, width=450, height=255)                  # Window dividing and choosing background color of the second part
